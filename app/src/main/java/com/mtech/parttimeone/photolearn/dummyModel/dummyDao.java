...
public class dummyDao {
    ...
    public ArrayList<TitleBO> GetTitleList(String SessionID){
        ...
        if (FixedID.equalsIgnoreCase(SessionID) == true) {
            ...
            //test
            TitleBO ls1 = (TitleBO) new LearningTitleBO("MTECH-ORO-002","All about IOT", "Zhi Kai");
            TitleBO ls2 = (TitleBO) new LearningTitleBO("MTECH-ORO-002","How to retrack the items", "Zhi Kai");
            TitleBO ls3 = (TitleBO) new LearningTitleBO("MTECH-ORO-002","History of the topic", "Zhi Kai");
            TitleBO ls4 = (TitleBO) new LearningTitleBO("MTECH-ORO-002","Overview", "Zhi Kai");
            TitleBO ls5 = (TitleBO) new LearningTitleBO("MTECH-ORO-002","How to get full marks", "Zhi Kai");
            TitleBO ls6 = (TitleBO) new LearningTitleBO("MTECH-ORO-002","How to go back in time", "Zhi Kai");
            TitleBO ls7 = (TitleBO) new LearningTitleBO("MTECH-ORO-002","History of the NUS", "Zhi Kai");
            TitleBO ls8 = (TitleBO) new LearningTitleBO("MTECH-ORO-002","Background", "Zhi Kai");
...
//        lsl.add(ls14);
    ...
    public ArrayList<TitleBO> GetQuizList(String SessionID){
        ...
        if (FixedID.equalsIgnoreCase(SessionID) == true) {
            ...
            //test
            TitleBO ls1 = (TitleBO) new QuizTitleBO("MTECH-ORO-002", "Formula Quiz", "Zhi Kai");
            TitleBO ls2 = (TitleBO) new QuizTitleBO("MTECH-ORO-002", "Chapter 1 Quiz", "Zhi Kai");
            TitleBO ls3 = (TitleBO) new QuizTitleBO("MTECH-ORO-002","Final Test", "Zhi Kai");
            TitleBO ls4 = (TitleBO) new QuizTitleBO("MTECH-ORO-002","Overview Quiz", "Zhi Kai");
            TitleBO ls5 = (TitleBO) new QuizTitleBO("MTECH-ORO-002","Test Chapter 1", "Zhi Kai");
            TitleBO ls6 = (TitleBO) new QuizTitleBO("MTECH-ORO-002","Test Chapter 2", "Zhi Kai");
            TitleBO ls7 = (TitleBO) new QuizTitleBO("MTECH-ORO-002","Test Chapter 3", "Zhi Kai");
            TitleBO ls8 = (TitleBO) new QuizTitleBO("MTECH-ORO-002","Test Chapter 4", "Zhi Kai");
    ...
    public void deleteLearningSession(Fragment f, String sessionId) throws Exception {

        LearningSessionViewModel lModel = ViewModelProviders.of(f).get(LearningSessionViewModel.class);

        String userName =getUserName(f);
        lModel.deleteLearningSession(sessionId,userName);
    ...
    public void updateLearningSession(Fragment f, LearningSessionBO learningSessionBO, String sessionId) throws Exception {
        ...
        String userName =getUserName(f);
        lModel.updateLearningSession(learningSessionBO,sessionId,userName);
